 ...
 */
public final class PostitionsResponse
{
	private String type;
	private List<StationResponse> features;
	...
	public List<StationResponse> getFeatures()
	{
		return features;
	}


	public void setFeatures(List<StationResponse> value)
	{
		this.features = value;
	}
}