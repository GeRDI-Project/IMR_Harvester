...
/**
 * This class provides Unit Tests for the {@linkplain ImrStationTransformer}.
 *
 * @author Robin Weiss
 */
@RequiredArgsConstructor
@RunWith(Parameterized.class)
public class ImrStationTransformerTest extends AbstractIteratorTransformerTest<ImrStationVO, DataCiteJson>
{
    ...
    @Override
    protected ImrStationVO getMockedInput()
    {
        final File resource = getResource(String.format(INPUT_RESOURCE, id));
